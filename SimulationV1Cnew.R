...
while(rep <= Rep){
  ...
  for(s in 1:S){
    ...
    ThetaPost[s,] <- c(THETASp12, THETASp34,THETAp[-c(1:6)])
  ...
  save(PostResults, file = "PostResultsJ3OneProduct.RData")
  ...
  save(MultiVarMod, file = "PostDrawsPostResultsJ3OneProduct.RData")
